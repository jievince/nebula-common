...
#ifndef COMMON_STORAGE_SCANEDGERESPONSEOPS_H_
#define COMMON_STORAGE_SCANEDGERESPONSEOPS_H_
...
/**************************************
 *
 * Ops for class ScanEdgeResponseOps
 *
 *************************************/
namespace detail {

template <>
struct TccStructTraits<nebula::ScanEdgeResponse> {
...
uint32_t Cpp2Ops<::nebula::ScanEdgeResponse>::write(Protocol* proto,
...
template <class Protocol>
void Cpp2Ops<::nebula::ScanEdgeResponse>::read(Protocol* proto, ::nebula::ScanEdgeResponse* obj) {
...
_readField_edge_data : {
    ::apache::thrift::Cpp2Ops<nebula::DataSet>::read(proto, &obj->edgeData);
...
_end:
    ...
    if (!isset_result) {
        TProtocolException::throwMissingRequiredField("result", "ScanEdgeResponse");
    }
    return;
...
_loop:
    ...
    if (proto->kUsesFieldNames()) {
        apache::thrift::detail::TccStructTraits<nebula::ScanEdgeResponse>::translateFieldName(
...
#endif   // COMMON_STORAGE_SCANEDGERESPONSEOPS_H_
